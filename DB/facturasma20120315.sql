...
--
-- Servidor: localhost
-- Tiempo de generación: 15-03-2012 a las 20:57:41
...
CREATE TABLE IF NOT EXISTS `cliente` (
  ...
  `rfc_cliente` varchar(150)  DEFAULT NULL,
  `calle` varchar(200)  DEFAULT NULL,
  `num_ext` varchar(100)  DEFAULT NULL,
  `num_int` varchar(100)  DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `factura` (
  ...
  `code_factura` varchar(40)  DEFAULT NULL,
